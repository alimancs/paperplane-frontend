        ...
        <div className="flex-1 flex gap-3 flex-col justify-center items-center text-[#17124f]">
            { !sendingEmail &&  (
                <div className="flex flex-col mt-[20px] md:w-[400px] w-[80%] gap-2">
                    ...
                    <input value={email} onChange={(e)=>{setEmail(e.target.value)}}  className="w-[100%] mt-[10px] rounded-[5px] outline-none mx-auto px-[10px] h-[40px] bg-[#d9dbdb]" placeholder="Enter email here..." type="email"/>
