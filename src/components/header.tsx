        ...
        <div className={`h-fit pb-5 pt-5 flex flex-row justify-between items-center md:px-10 px-4 w-full border-b-[0.1px] border-b-gray-200`}>
            ...
            <div className="flex flex-row items-center gap-5 md:gap-7">
                <button className="md:hidden flex cursor-pointer hover:bg-gray-100 rounded-full p-1 transition-all duration-300 ease-in-out">
                    <Search strokeWidth={1} className={`h-5 w-5 hover:text-[${colors.secondary}] text-[${colors.primary}]`}/>
                </button>
                <button className="md:flex hidden cursor-pointer hover:bg-gray-100 rounded-full hover:px-3 transition-all duration-300 ease-in-out flex-row items-center gap-1">
                    <PenBox strokeWidth={1} className={`h-5 w-5 text-gray-500 hover:text-[${colors.primary}]`}/>
                    <span className={`text-[14px] font-ptsans-regular text-gray-500 hover:text-[${colors.primary}]`}>Write</span>
                </button>
                <button className="cursor-pointer hover:bg-gray-100 rounded-full p-1 transition-all duration-300 ease-in-out">
                    <Bell strokeWidth={1} className={`h-5 w-5 text-gray-500 hover:text-[${colors.primary}]`}/>
                </button>
                <button className="cursor-pointer hover:bg-gray-100 rounded-full p-1 transition-all duration-300 ease-in-out">
